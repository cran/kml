...
plot(lcl3)
plot(lcl3,criterion=c("random","Calinski.Harabatz"))
...
plot(lcl0,criterion=c("Calinski.Harabatz","Calinski.Genolini","Davies.Bouldin"))
plot(lcl3,criterion=CRITERION_NAMES)
ordered(lcl3)
plot(lcl3,criterion=c("Calinski.Harabatz","Calinski.Genolini","Davies.Bouldin"))
